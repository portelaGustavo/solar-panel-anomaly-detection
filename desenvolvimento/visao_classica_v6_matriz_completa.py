...
# %% [markdown]
# ## Matriz de confusão completa (XGBoost, 181 features)
#
# Treina o XGBoost único nas 181 features (versão antes da redução) e gera a matriz de
# confusão com a contagem absoluta, em azul.
...
print("XGB unico — acuracia: {:.1f}% | F1 macro: {:.1f}%".format(
...
plt.title("Matriz de confusao XGBoost (contagem absoluta) - 181 features, 12 classes", fontsize=13)
plt.ylabel("Classe Verdadeira")
plt.xlabel("Previsao")
plt.xticks(rotation=45, ha="right")
plt.tight_layout()
plt.savefig(REL / "matriz_xgb_completa.png", dpi=130)
plt.close()
print("[salvo]", REL / "matriz_xgb_completa.png")
