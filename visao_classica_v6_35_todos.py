...
def treina_prediz(Xa, ya, Xb, model_name):
    """Treina (RF, GB, SVM ou XGB) em (Xa, ya) e prediz Xb. Abstrai o encoding do XGB."""
    if model_name == "RF":
...
# %% [markdown]
# ## 3.5 Classificacao em duas etapas (RF, GB, SVM e XGB)
#
# Etapa 1: anomalia vs No-Anomaly. Etapa 2: tipo (so nas anomalias). Compara modelo unico
# (12 classes de uma vez) vs duas etapas, para os quatro classificadores.
