...
# %% [markdown]
# ## 3.6 Analise do melhor modelo (XGBoost)
#
# Treina o XGBoost unico nas 181 features e analisa os erros: matriz de confusao
# normalizada por coluna (precision) e por linha (recall), alem da tabela das maiores
# confusoes por classe.
...
def salva_matriz(norm, nome_png, titulo, xlabel):
    ...
    plt.tight_layout()
    plt.savefig(REL / nome_png, dpi=130)
    plt.close()
    print("[salvo]", REL / nome_png)
    return cm
